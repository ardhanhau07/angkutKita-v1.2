...
import '../../../driver/rootDriver/views/root_driver_view.dart';
import '../controllers/phone_confirmation_controller.dart';

class PhoneConfirmationView extends GetView<PhoneConfirmationController> {
  const PhoneConfirmationView({super.key});
  @override
