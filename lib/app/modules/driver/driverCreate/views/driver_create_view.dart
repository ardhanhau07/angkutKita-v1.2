import 'package:angkut_kita/app/modules/driver/driverEmailConfirm/views/driver_email_confirm_view.dart';
...
class DriverCreateView extends GetView<DriverCreateController> {
  const DriverCreateView({super.key});
  @override
